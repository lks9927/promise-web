            ...
            <div className="space-y-3">
                {teamMembers.length === 0 ? (
                    ...
                    teamMembers.map(member => {
                        ...
                        const inProgressCount = cases.filter(c => ['assigned', 'consulting', 'in_progress'].includes(c.status)).length;
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <span className="text-[10px] font-medium bg-blue-50 text-blue-600 px-2 py-0.5 rounded">수행 {inProgressCount}</span>
